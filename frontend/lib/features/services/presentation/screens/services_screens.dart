            ...
            FilledButton(
              onPressed: () async {
                ...
                if (ok) {
                  ...
                  if (parentContext.mounted) ScaffoldMessenger.of(parentContext).showSnackBar(SnackBar(content: Text(error)));
                }
              },
...
class _RegisterProviderScreenState
  ...
  Future<void> _submit() async {
    // categoría ahora opcional; solo validar profesión y descripción
    ...
    if (_cvPath == null || !_cvPath!.toLowerCase().endsWith('.pdf')) {
      setState(() => _error = 'Adjunta tu CV en formato PDF');
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 24),
            // No mostrar selección de categoría en el formulario simplificado
            const SizedBox(height: 8),
            AppTextField(
            ...
            AppTextField(
              ...
              hintText: 'Tu número de contacto',
              keyboardType: TextInputType.phone,
            ),
            const SizedBox(height: 16),
            AppTextField(
            ...
            OutlinedButton.icon(
              onPressed: () async {
                ...
                if (res != null && res.files.single.path != null) {
                  setState(() => _cvPath = res.files.single.path);
                }
              },
