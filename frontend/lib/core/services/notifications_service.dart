...
class NotificationsService {
  ...
  /// Notificación de nueva solicitud de domicilio disponible (para domiciliarios).
  static Future<void> showNewDeliveryRequest({
    required int requestId,
    ...
    await _show(
      ...
      body: 'De: $pickupAddress → A: $deliveryAddress',
