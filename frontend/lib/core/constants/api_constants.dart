...
class ApiConstants {
  static String get baseUrl {
    final defaultUrl = 'http://127.0.0.1:8000/api/v1';
    final rawBaseUrl =
  ...
  static const String availableDeliveryRequests = '/deliveries/requests/available/';
  ...
  static String cancelDelivery(int id) => '/deliveries/requests/$id/cancel/';
  ...
  static const String deliveriesReport = '/reports/deliveries/';
  static const String deliverersReport = '/reports/deliverers/';
  static const String financeReport = '/reports/finance/';
  static const String contactsReport = '/reports/contacts/';
